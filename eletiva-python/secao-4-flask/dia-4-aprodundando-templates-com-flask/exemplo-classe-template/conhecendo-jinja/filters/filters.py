...
# Adicionamos o filtro customizado ao ambiente, poderia ter sido
# dado qualquer nome ao nosso filtro
# O nome que for passado dentro dos colchetes como uma string,
# é o nome que irá ser chamado no template
...
data = {
    ...
    'date': '2023-05-21',  # Adicionamos a nova informação ao contexto
}
